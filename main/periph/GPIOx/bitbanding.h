...
#define BIT_BAND_PER_MASK(REG,BIT_MASK) (*(volatile uint32_t*)(PERIPH_BB_BASE+32*((uint32_t)((REG))-PERIPH_BASE)+4*((uint32_t)(MASK_TO_BIT(BIT_MASK)))))
#define BIT_BAND_PER(REG,BIT) (*(volatile uint32_t*)(PERIPH_BB_BASE+32*((uint32_t)((void*)(REG))-PERIPH_BASE)+4*((uint32_t)(BIT))))
